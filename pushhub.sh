...
var=("tapcommon-upm" "tapdb-upm" "tapmoment-upm" "tapbootstrap-upm" "taplogin-upm" "taplicense-upm")
...
module=("Common" "TapDB" "Moment" "Bootstrap" "Login" "License")

#githubRepoName=("TapCommon" "TapDB" "TapMoment" "TapBootstrap" "TapLogin" "TapFriends" "TapLicense" "TapFriendsUI")
githubRepoName=("TapCommon" "TapDB" "TapMoment" "TapBootstrap" "TapLogin" "TapLicense")
