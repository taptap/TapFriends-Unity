...
public class TapDBScene : MonoBehaviour
{
    ...
    void Start()
    {
        TapDB.TapDB.Init("0RiAlMny7jiz086FaU", "channel", "gameVersion");
    }
