...
function RemoveNativePackage(){
  ...
  if [ $releaseIOS == true ];then
      ...
      mkdir $rootPath/Assets/TapTap/$1/Plugins/tempDll/
      
      cp $rootPath/Assets/TapTap/$1/Plugins/iOS/TapTap.$1.dll.meta $rootPath/Assets/TapTap/$1/Plugins/tempDll/TapTap.$1.dll.meta
    
      rm -fr $rootPath/Assets/TapTap/$1/Plugins/iOS/*
      
      cp $rootPath/Assets/TapTap/$1/Plugins/tempDll/TapTap.$1.dll.meta $rootPath/Assets/TapTap/$1/Plugins/iOS/TapTap.$1.dll.meta
      
      rm -fr $rootPath/Assets/TapTap/$1/Plugins/tempDll
