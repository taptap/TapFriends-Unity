...
core=("Common" "TapDB" "Moment" "Bootstrap" "Login" "License" "Achievement" "Desk")

module=("TapCommonSDK" "TapDBSDK" "TapMomentSDK" "TapBootstrapSDK" "TapLoginSDK" "TapLicense" "TapAchievementSDK" "TapDesk")
...
function compileDll(){
    ...
    if  [ "$1" == "TapBootstrapSDK" -o  "$1" == "TapDesk" ];then
        cd $1
